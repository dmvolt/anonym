...
class Text
{
	...
	public static function _editFull($id = 1, $module = 'main')
	{
		$link = '';
...
JS;
			...
			if($is_del_button)
			{
				$link .= Html::a('<span class="glyphicon glyphicon-trash" aria-hidden="true"></span>', '/admin/'.$module.'/delete-fast?id='.$id, ['class' => 'btn_delete', 'title' => 'Удалить']);
			}
			$link .= '</p>';
		}
		return $link;
